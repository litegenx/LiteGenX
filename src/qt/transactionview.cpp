                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received litegenx from zlitegenx"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zlitegenx"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zlitegenx));
