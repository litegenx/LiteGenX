...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach (const SendCoinsRecipient& rcp, recipients) {
        ...
        // generate molitegenxpace address string
        QString address = "<span style='font-family: molitegenxpace;'>" + rcp.address;
        address.append("</span>");
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid litegenx address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
