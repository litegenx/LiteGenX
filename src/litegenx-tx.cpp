...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LiteGenX Core litegenx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  litegenx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litegenx transaction") + "\n" +
                               "  litegenx-tx [options] -create [commands]   " + _("Create hex-encoded litegenx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded litegenx transaction
