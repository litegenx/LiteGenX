Contributing to LiteGenX Core
============================

The LiteGenX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/litegenx-project/litegenx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LiteGenX Core project, and is not to be
confused with overall LiteGenX Network Protocol consensus changes.

Whether a pull request is merged into LiteGenX Core rests with the project merge
...
Patches that change LiteGenX consensus rules are considerably more involved than
...
Where a patchset proposes to change the LiteGenX consensus, it must have been
...
The project leader is the release manager for each LiteGenX Core release.
