...
/** Utility functions used by the litegenx Qt UI.
 */
namespace GUIUtil
{
...
// Render litegenx addresses in molitegenxpace font
...
// Parse "litegenx:" URI into recipient object, return true on successful parsing
