...
void CoinMixingConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("CoinMixing Configuration"),
        tr(
            "CoinMixing was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening litegenx's configuration screen.")
            .arg(strAmount));
...
void CoinMixingConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("CoinMixing Configuration"),
        tr(
            "CoinMixing was successfully set to high (%1 and 8 rounds). You can change this at any time by opening litegenx's configuration screen.")
            .arg(strAmount));
...
void CoinMixingConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("CoinMixing Configuration"),
        tr(
            "CoinMixing was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening litegenx's configuration screen.")
            .arg(strAmount));
