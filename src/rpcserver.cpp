...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop litegenx server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "litegenx server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* litegenx features */
        {"litegenx", "masternode", &masternode, true, true, false},
        {"litegenx", "listmasternodes", &listmasternodes, true, true, false},
        {"litegenx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"litegenx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"litegenx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"litegenx", "masternodedebug", &masternodedebug, true, true, false},
        {"litegenx", "startmasternode", &startmasternode, true, true, false},
        {"litegenx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"litegenx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"litegenx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"litegenx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"litegenx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"litegenx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"litegenx", "mnbudget", &mnbudget, true, true, false},
        {"litegenx", "preparebudget", &preparebudget, true, true, false},
        {"litegenx", "submitbudget", &submitbudget, true, true, false},
        {"litegenx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"litegenx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"litegenx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"litegenx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"litegenx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"litegenx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"litegenx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"litegenx", "checkbudgets", &checkbudgets, true, true, false},
        {"litegenx", "mnsync", &mnsync, true, true, false},
        {"litegenx", "spork", &spork, true, true, false},
        {"litegenx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"litegenx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use litegenxd, or the -server option to litegenx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> litegenx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3356/\n";
}
