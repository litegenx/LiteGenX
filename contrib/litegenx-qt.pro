...
RESOURCES += src/qt/litegenx.qrc src/qt/litegenx_locale.qrc

TRANSLATIONS += src/qt/locale/litegenx_bg.ts \
                src/qt/locale/litegenx_de.ts \
                src/qt/locale/litegenx_en.ts \
                src/qt/locale/litegenx_es.ts \
                src/qt/locale/litegenx_fi.ts \
                src/qt/locale/litegenx_fr.ts \
                src/qt/locale/litegenx_it.ts \
                src/qt/locale/litegenx_ja.ts \
                src/qt/locale/litegenx_pl.ts \
                src/qt/locale/litegenx_pt.ts \
                src/qt/locale/litegenx_ru.ts \
                src/qt/locale/litegenx_sk.ts \
                src/qt/locale/litegenx_sv.ts \
                src/qt/locale/litegenx_vi.ts \
                src/qt/locale/litegenx_zh_CN.ts \
                src/qt/locale/litegenx_zh_TW.ts
