                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LiteGenX ") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #fd9c02, stop: 1 #fd9c02); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a litegenx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and litegenx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLGX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LiteGenX Core"), this);
    aboutAction->setStatusTip(tr("Show information about LiteGenX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for litegenx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your litegenx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified litegenx addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diaglitegenxtic information"));
    ...
    openAction->setStatusTip(tr("Open a litegenx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LiteGenX Core help message to get a list with possible litegenx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LiteGenX Client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to litegenx network", "", count));
}
...
{
    QString strTitle = tr("LiteGenX Core"); // default title
...
/** Creates context menu, its actions, and litegenxs up all the relevant signals for mouse events. */
