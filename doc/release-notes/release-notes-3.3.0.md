LiteGenX Core version *3.3.0* is now available from:  <https://github.com/litegenx-project/litegenx/releases>
...
The `masternode` and `mnbudget` RPC commands, which were marked as deprecated in LiteGenX Core v2.3.1 (September 19, 2017), have now been completely removed from LiteGenX Core.

Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://github.com/LiteGenX-Project/LiteGenX/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.
