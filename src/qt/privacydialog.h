...
public:
    ...
    void setZlitegenxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzLGX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLGX_clicked();
    void on_pushButtonZlitegenxControl_clicked();
