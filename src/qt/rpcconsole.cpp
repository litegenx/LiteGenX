...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        ...
        "td.message { font-family: Courier, Courier New, Lucida Console, molitegenxpace; font-size: 12px; } " // Todo: Remove fixed font-size
        "td.cmd-request { color: #006060; } "
        "td.cmd-error { color: red; } "
        "b { color: #006060; } ");

    message(CMD_REPLY, (tr("LiteGenX RPC Console.") + "<br>" + tr("Use up and down arrows to navigate history, and <b>Ctrl-L</b> to clear screen.") + "<br>" + tr("Type <b>help</b> for an overview of available commands.")),
        true);
}
